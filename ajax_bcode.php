...
?>
                            ...
                            <div class="col-sm-12">
                                    ...
                                    <table id="usetable" class="table table table-hover m-0 ">
	...
	else
	{
		...
		if ($result->num_rows > 0)
		{
			...
			while($row = $result->fetch_assoc())
			{
				...
				{
				  echo "<td><a class='btn btn-success btn-md button_style_addon' href='#' onClick='Show_Receival1($id);stocks($sid)'; style='border-radius: 5px;'>View <span class='glyphicon glyphicon-barcode'></span> </a> 
				  <a href='#' class='btn btn-danger btn-md button_style_addon' style='border-radius: 5px;' onClick='Remove_barcode($id);'><span class='glyphicon glyphicon-remove'></span> Del</a></td></tr>";
				}
