	...
	function add_fields()
	{
				...
				//	document.getElementById('stu_id').value =id;
                   ...
                   var name =receival_object.name;
					...
					var cond= receival_object.cond;
                       	...
                       	localStorage.setItem('bar',barcode);
					//alert(barcode);
					document.getElementById('barcode').value = "";
					document.getElementById('field_row_'+inline_item_index+'_isbn').value = isbn;
					...
					document.getElementById('field_row_'+inline_item_index+'_auth').value = auth;
					document.getElementById('field_row_'+inline_item_index+'_cond').value = cond;
		...
		new_line_item.innerHTML = ''
		                   ...
		                   // this is the 1st option select 
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_isbn" name="papersheet" type="text"  placeholder="ISBN" readonly/>'
								 +'		</div>'
								 +'	</div>'
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_barcode" name="papersheet" type="text"  placeholder="Barcode" readonly/>'
								 +'		</div>'
								 +'	</div>'
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_name" name="papersheet" type="text"  placeholder="Title" readonly/>'
								 +'		</div>'
								 +'	</div>'
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_auth" name="papersheet" type="text"  placeholder="Author" readonly/>'
								 +'		</div>'
								 +'	</div>'
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_cond" name="papersheet" type="text"  placeholder="Condition" readonly/>'
								 +'		</div>'
								 +'	</div>'
	...
	function add_fields1()
	{
				...
				//	document.getElementById('stu_id').value =id;
                   ...
                   var name =receival_object.name;
					...
					var cond= receival_object.cond;
                       	...
                       	localStorage.setItem('bar1',barcode);
					//alert(barcode);
					document.getElementById('barcode').value = "";
		...
		new_line_item.innerHTML = ''
		                   ...
		                   // this is the 1st option select 
								...
								+'			<input class="form-control" id="field_row_'+inline_item_index+'_authr" name="papersheet" type="text"  placeholder="Author" readonly/>'
								 +'		</div>'
								 +'	</div>'
								...
								+'			<select class="grouped_select required form-control Stocks" name="return" id="field_row_'+inline_item_index+'_returncond">'
	...
	*/
	...
	var bar=localStorage.getItem('bar');
		...
		new_line_item.innerHTML = ''
								...
								+'			<input class="form-control" id="newfield_row_'+edit_new_inline_item_index+'auth" name="auth" type="text"  placeholder="Author" readonly/>'
								 +'		</div>'
								 +'	</div>'
...
document.getElementById('ebarcode').value = "";
	...
	//var id="field_row_'+inline_item_index+'_stock";
		...
		xhttp.send("Query=Add_rental&sid="+stu_id+"&Recdate="+Recdate+"&fname="+fname+"&dob="+dob+"&grade="+grade+"&Inline_items="+Inline_items_Sringyfied);
	...
	//	alert('yes'); 
		...
		var dob = document.getElementById("dobr").value;
		var grade = document.getElementById("grade1r").value;
	...
	//var id="field_row_'+inline_item_index+'_stock";
		...
		xhttp.send("Query=Add_return&sid="+stu_id+"&Recdate="+Recdate+"&fname="+fname+"&dob="+dob+"&grade="+grade+"&Inline_items="+Inline_items_Sringyfied);
		//alert(Inline_items_Sringyfied );
		//alert("End"); 
	}
	...
	*/
	...
	{
	//alert(id);
	//document.getElementById('name').value ="Mew";
		var xhttp = new XMLHttpRequest();
		...
		xhttp.onreadystatechange = function()
		{
			if(xhttp.readyState == 4)
			{
				if(xhttp.status == 200)
				{
					...
					document.getElementById('name').value =receival_object.fullname;
					//document.getElementById('grade').value =receival_object.grade;
				//	document.getElementById('date').value = receival_object.dob;
			...
			if(xhttp_line_items.readyState == 4)
			{
				if(xhttp_line_items.status == 200)
				{
					...
					for (a = 0; a < line_item_objects.length; a++)
					{
						...
						Edit_add_field(a,line_item_objects[a].barcode,line_item_objects[a].name,line_item_objects[a].cond,line_item_objects[a].rentdate,line_item_objects[a].rdate); 
		...
		xhttp_line_items.open("GET", "php/Query_Manager.php?Query=Get_checkbook_JSON&id="+id, true); 
    ...
    xhttp.open("GET", "php/Query_Manager.php?Query=Basic_checkbook_info&id="+id, true);
		xhttp.send();
		switch_page(2);
	...
	*/
	...
	function Edit_add_field(row_num,ib,title,cond,auth,rid)
	{
	//alert(rid);
		...
		new_line_item.innerHTML = ''
		                   ...
		                   // this is the 1st option select
		                     ...
		                     +'<hr style="height: 1px; width: 100%; background-color: #999999;"/>'
								 ...
								 +'		<div class="input-group">'
								 +'			<div class="input-group-addon">'
								 +'				<span class="">Rent Date</span>'
								 +'			</div>'
							
								 +'	 <input class="form-control" id="edit_field_row_'+edit_inline_item_index+'_name" name="id" type="text" value="'+auth+'" placeholder="Rent Date"/>'
								 ...
								 +'	 <input class="form-control" id="edit_field_row_'+edit_inline_item_index+'_isbn" name="id" type="text" value="'+title+'" placeholder="Title"/>'
								 ...
								 +'	 <input class="form-control" id="edit_field_row_'+edit_inline_item_index+'_bar" name="id" type="text" value="'+ib+'" placeholder="Book ID"/>'
								 ...
								 +'	 <input class="form-control" id="edit_field_row_'+edit_inline_item_index+'_rid" name="id" type="text" value="'+rid+'" placeholder="Return date"/>'
...
function Rtest2(id) //This is the function to remove the receivals for the Receival Tabel
	...
	function Show_Receival(id)
	{
				...
				if(xhttp.status == 200)
				{
				  ...
				  // alert(xhttp.responseText);
                   ...
                   var f =receival_object.fname;
					var m = receival_object.mname;
					var l= receival_object.lname;
					var fullname=f+" "+m+" "+l;
					document.getElementById('fname').value = fullname;
					document.getElementById('dob').value = receival_object.dob;
					g=document.getElementById('grade1').value = receival_object.grade;
					alert(g);
					switch_page(1);
		...
		xhttp.open("GET", "php/Query_Manager.php?Query=Basic_student&id="+id+"&location="+location, true);
		xhttp.send();
    ...
    <body onload="" class="fixed-left">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Book Rental</h4>
                                </div>
                            </div>
                        </div>
     <div class="card-box" >
 	...
 	<!--banner-->	
		    <div class="banner" id="usg1" style="display:block">
		    	...
		    	<h5>
				<a href="#" onClick="switch_page(0);" style="color: #22A7F0;">Students Rental History</a> &nbsp;&nbsp; &nbsp;&nbsp;
 	 ...
 	 <!--This is the Usage inventory-->
 	   ...
 	   <div id="student_rent" class="row" style="display: none">
                        	
                            <div class="col-sm-12">
                               

                                    <h4 class="m-t-0 header-title"><b>Students</b></h4>
	...
	else
	{
		...
		if ($result->num_rows > 0)
		{
			...
			while($row = $result->fetch_assoc())
			{
				...
				{
				  echo "<td><a class='btn btn-primary btn-md button_style_addon' href='#' onClick='Show_Receival($id);stocks($sid)'; style='border-radius: 5px;'>Rent<span class='glyphicon glyphicon-edit'></span> </a> <a href='#' class='btn btn-success btn-md button_style_addon' style='border-radius: 5px;' onClick='Show_Return($id);'><span class=''></span> Return</a></td></tr>";
				}
...
?> 	
 	...
 	<div id="Receival_listing" class="blank" style="display: block; overflow-y: none;">
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                 ...
                                 <div id="Receival_listing_Message" style="padding: 10px; text-align: center">
                                    ...
                                    <table id="datatable-fixed-header2" class="table table table-hover ">
...
//$sql = "SELECT DISTINCT fullname,id
//	FROM checkbook
//	WHERE return_date='' AND fullname!='' AND rent_date!=''
	//GROUP BY fullname";
	
$sql = "SELECT fullname,id,return_date
         FROM checkbook
	WHERE fullname!='' AND return_date='' OR return_date IS NOT NULL
			...
			while($row = $result->fetch_assoc())
			{
										   ...
										   $id=$row["id"];
										       ...
										       $ref=$row["num_ref"];
												...
												if($returndate==''){
													$returndate="Please Return";
												}
                                                else{
													$returndate="No Outstanding";
											...
											if($returndate=="Please Return"){
													
													echo"<td id='test' class='text-warning'><b>$returndate</b></td>";	
												}
											else{
													
													echo"<td id='test' class='text-success'><b>$returndate</b></td>";	
												}
			...
			if($GLOBALS['role']>0 && $GLOBALS['role']<3)
				{
				  ...
				  echo "<td align='center'> <a class='btn btn-primary btn-md button_style_addon' href='#' onClick='Show_Edit_Usage($id);' style='border-radius: 5px;'><span class='glyphicon glyphicon-edit'></span> View</a> </td></tr>";
				}
...
<!--*************** Create Usages Page ****************************************************************************************************************************************************************data -->
		...
		<form id="Edit_Create_ID" data-toggle="validator" role="form" class="" autocomplete="off">
			<div class="form-group">
				<div class="row col-md-12 custyle">
									...
									<div class="input-group">
										<div class="input-group-addon">Student Name
											<span class=""></span> 
										</div>
										<input class="form-control" id="name" name="name" type="text" placeholder="Student Name" readonly=""/>
									...
									<div class="input-group"  style="display: none;">
										...
										<input class="form-control" id="date" name="date" type="text" placeholder="Rental Date">
									</div>
									<div class="help-block with-errors"></div>
									
									
									<div class="input-group"  style="display: none;">
										<div class="input-group-addon">Grade
											<span class=""></span> 
										</div>
		...
		<form id="Create_ID" data-toggle="validator" role="form" class="" autocomplete="off">
			<div class="form-group">
				<div class="row col-md-12 custyle">
									...
									<div class="input-group">
										<div class="input-group-addon">
											<span class=""></span> Student #
										</div>
										<input class="form-control" id="stu_id" name="stu_id" type="text" placeholder="Student #" readonly/>
									</div>
									<div class="help-block with-errors"></div>
									
										<div class="input-group">
										<div class="input-group-addon">
											<span class=""></span> Grade
										</div>
										<input class="form-control" id="grade1" name="grade" type="text" placeholder="Grade" readonly/>
									</div>
									<div class="help-block with-errors"></div>
									...
									<div id="firstname" class="input-group">
										...
										<input class="form-control" id="fname" name="fname" type="text" placeholder="Fullname" readonly/>
									</div>
									<br/>
								<div id="firstname" class="input-group">
										<div class="input-group-addon">
											<span class=""></span> D.O.B
										</div>
									...
									<div class="help-block with-errors"></div>
										...
										<div class="input-group">
										<div class="input-group-addon">
											<span class=""></span> Rental Date
										</div>
										<input class="form-control" id="Recdate" name="Recdate" type="text" placeholder="Rent Date"/>
									</div>
									<div class="help-block with-errors"></div>	
									
									<div class="input-group">
										<div class="input-group-addon">
											<span class=""></span> BARCODE
										</div>
	...
	<div id="Enter_Return" class="blank" style="display: none; overflow-y: auto;">
		<form id="Create_ID1" data-toggle="validator" role="form" class="" autocomplete="off">
			<div class="form-group">
				<div class="row col-md-12 custyle">
									...
									<div class="input-group">
										...
										<input class="form-control" id="stu_idr" name="stu_id" type="text" placeholder="Student #" readonly/>
									</div>
									<div class="help-block with-errors"></div>
										...
										<input class="form-control" id="grade1r" name="grade" type="text" placeholder="Grade" readonly/>
									</div>
									<div class="help-block with-errors"></div>
									...
									<div id="firstname" class="input-group">
										...
										<input class="form-control" id="fnamer" name="fname" type="text" placeholder="Fullname" readonly/>
									</div>
									<br/>
								<div id="firstname" class="input-group">
										<div class="input-group-addon">
										...
										<input class="form-control" id="dobr" name="dob" type="text" placeholder="D.O.B" readonly/>
									</div>
									<br/>
									...
									<div class="help-block with-errors"></div>
										...
										<div class="input-group">
										<div class="input-group-addon">
											<span class=""></span> Return Date
										</div>
										<input class="form-control" id="Recdater" name="Recdate" type="text" placeholder="Return Date"/>
									</div>
									<div class="help-block with-errors"></div>	
									...
									<div class="input-group">
										...
										<input class="form-control" id="barcoder" name="barcode" type="text" placeholder="Barcode"/>
									</div>
									<div class="help-block with-errors"></div>		
				...
				<div id="fieldsr">   <!--This is the page input usage item starts here ****************************************-->
				 
				</div>
				<br/>
			<button type="submit" class="btn btn-primary" style="border-radius: 10px;" onClick="add_fields1();"> <span class="glyphicon glyphicon-plus">&nbsp;Scan Barcode</span></button><!--This add new row in -->	
			
			<br/>

			<center>
					<button type="button" id="use" class="btn btn-success" style="width: 80%; border-radius: 10px;" onClick="Create_Return();">Process Return&nbsp;<span class="glyphicon glyphicon-plus-sign"></span></button>
				</center>	
