...
$(document).on('click', '.btn_delete', function(){  
                            ...
                            <li class="has_sub">
                                <a href="" class="waves-effect waves-primary"><i
                                        ...
                                        class="menu-arrow"></span> </a>
                                         <ul class="list-unstyled">
                                    <li id=""><a href="profile1.php"> Receivals</a></li>
                                    <li ><a href="javascript:void(0);" onClick="switch_page(1);">Add Receivals</a></li>
  ...
  <div id="live-data">
                        	...
                        	<div class="col-sm-12">
                        		...
                        		<img src="assets/images/streamline.jpg" width="20%"alt="logo" >  
                        			
                        		<div>  
                        			
                        	   <p>9 Moylnes Road Kingston 10 <br>Tel: (876) 908-4806 <br>Fax#: (876) 908-4944
                               </p>	
                        			</div>
